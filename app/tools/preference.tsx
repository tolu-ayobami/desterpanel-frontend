...
import {
  ...
  import review from "../datas/preferencedata";
    ...
    return(
        ...
        <AccordionItem value="item-1" className="accordionitem">
          <AccordionTrigger className="text-blue-800 px-[10px] "><div className="flex gap-[15px] align-center">
			<Image src="../home_panel_icons/preferences_icons/preferences.svg" className="my-[auto]" alt="image" width={25} height={25} />
		    <p className="text-black my-[auto]">Preferences</p>
			</div>
			</AccordionTrigger>
