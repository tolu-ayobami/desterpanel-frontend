...
import {
  ...
  import review from "../datas/domainsdata";
    ...
    return(
        ...
        <AccordionItem value="item-1" className="accordionitem">
          <AccordionTrigger className="text-blue-800 px-[10px] "><div className="flex gap-[15px] align-center">
			<Image src="../home_panel_icons/domains_icons/domains.svg" className="my-[auto]" alt="image" width={25} height={25}/>
		    <p className="text-black my-[auto]">Domains</p>
			</div>
			</AccordionTrigger>
