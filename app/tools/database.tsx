...
import {
  ...
  import review from "../datas/databasedata";
    ...
    return(
        ...
        <AccordionItem value="item-1" className="accordionitem">
          <AccordionTrigger className="text-blue-800 px-[10px] "><div className="flex gap-[15px] align-center">
			<Image src="../home_panel_icons/database_icons/databases.svg" className="my-[auto]" alt="image" width={25} height={25} />
		    <p className="text-black my-[auto]">Databases</p>
			</div>
			</AccordionTrigger>
