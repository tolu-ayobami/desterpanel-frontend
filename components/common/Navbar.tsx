...
const Navbar = () => {
	...
	return (
		<div className="fixed top-0 z-[100] bg-white p-[22px] flex justify-between align-center shadow-md w-[100%]">
			...
			{show ? (
				<div className="flex gap-[20px] justify-end align-item w-[100%]">
					...
					<Image
						...
						alt="image"
						onClick={toggle}
						className="max-md:flex hidden cursor-pointer max-md:w-[18px]"
						width={20}
						height={20}
					/>
					...
					<div className="flex align-center gap-[20px]">
						...
						<div className="flex gap-[10px] align-center">
							...
							<div className="my-[auto]">
								<p className="font-bold text-[14px] max-md:text-[12px]">
									John Doe
								</p>
				...
				<div className=" flex align-center gap-[5px]">
					<p onClick={toggle} className="my-[auto] cursor-pointer">
						back
					</p>
