...
import {
  ...
  import review from "../datas/Emaildata";
...
import Image from "next/image";
  ...
  const Email = () =>{
    return(
        <div className="">
        <h2 className="w-[48%] max-md:w-[90%]  m-[auto] mt-[40px] text-[25px] font-bold">Tools</h2>
        ...
        <AccordionItem value="item-1" className="accordionitem">
          <AccordionTrigger className="text-blue-800 px-[10px] "><div className="flex gap-[15px] align-center">
			<Image src="../home_panel_icons/email_icons/email.svg" className="my-[auto]" alt="image" width={25} height={25} />
